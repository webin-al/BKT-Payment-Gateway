...
add_action( 'woocommerce_thankyou', 'bkt_details_after_success_payment', 10, 1 );
	...
	*Read our Terms and Conditions for cancellations or refunds.
	...
	// save the receipt in the server
	$pdfpath = $_SERVER['DOCUMENT_ROOT'];
	include_once $pdfpath . '/wp-load.php';

	require_once $pdfpath . '/wp-content/plugins/bkt-payment-gateway/vendor/autoload.php';
